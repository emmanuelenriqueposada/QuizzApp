...
const cuestionarios = {
  ...
  accesibilidad: {
    ...
    preguntas: [
      ...
      {
        pregunta:
          "¿Cuál es uno de los principios fundamentales de la accesibilidad según WCAG?",
        opciones: ["Perceptible", "Visible", "Dinámico", "Animado"],
        respuesta: 0,
      },
      {
        pregunta:
          "¿Qué herramienta permite navegar por una página web sin usar el ratón?",
        opciones: ["Teclado", "Touchpad", "Ratón óptico", "Pantalla táctil"],
        respuesta: 0,
      },
      {
        pregunta:
          "¿Qué indica el orden de tabulación (tabindex) en una página web?",
        opciones: [
      ...
      {
        pregunta:
          "¿Cuál de estas tecnologías ayuda a usuarios con discapacidad visual a navegar por páginas web?",
        opciones: [
          "Lector de pantalla",
          "Zoom del navegador",
          "Modo oscuro",
      ...
      {
        pregunta:
          "¿Qué se debe evitar para mejorar la accesibilidad del contenido?",
        opciones: [
...
function siguientePregunta() {
  if (opcionSeleccionada === null) {
    Swal.fire({
      //Alerta en dado caso no se haya seleccionado una respuesta
      icon: "warning",
      background: "#000000",
      color: "#f27900",
  ...
  if (
    ...
    const Toast = Swal.mixin({
      //Mensaje para el caso en donde la respuesta seleccionada es la correcta
      width: "200px",
      background: "#ffffff",
      color: "#000000",
      position: "center",
